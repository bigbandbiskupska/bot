...
class HomepagePresenter extends BasePresenter
{
	...
	public function actionDefault ()
	{
		...
		$real = [];
		foreach ($members as $sec => $mbs)
			$real = array_merge ( $real, $mbs );

		$member = $real [ array_rand($real) ];

		$this->template->name = $member->name;
		$this->template->description = $this->generateDescription($member);
	...
	public function generateDescription( $member ) {
		...
		$movies = [
			...
			"Vrchní {\$instrument|case: 5} prchni",
		...
		$instruments = [
			...
			"kytara" => [ "kytara", "kytary", "kytarou", "kytaru", "kytaro", "kytaře", "kytarou" ],
			"lesní roh" => [ "lesní roh", "lesního rohu", "lesnímu rohu", "lesní roh", "lesní rohu", "lesním rohu", "lesním rohem" ],
			"dirigent" => [ "dirigent", "dirigenta", "dirigentovi", "dirigenta", "dirigente", "dirigentovi", "dirigentem" ],
		];
		...
		$words = [
			...
			"lesní rohy" => [ "lesní rohy", "lesních rohů", "lesním rohům", "lesní rohy", "lesní rohy", "lesních rozích", "lesními rohy" ],
			"dirigenti" => [ "dirigenti", "dirigentů", "dirigentům", "dirigenty", "dirigenti", "dirigentích", "dirigenty" ],
